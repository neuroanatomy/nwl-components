  ...
  <div class="adjust-settings">
    ...
    <div class="setting">
      ...
      <RangeSlider
        :max="100"
        v-model="alpha"
        @update:model-value="emit('changeAlpha', $event)"
    ...
    <div class="setting">
      <img
        src="@/assets/sun-o.svg"
        class="icon"
      >
      <RangeSlider
        :max="100"
        v-model="brightness"
        @update:model-value="emit('changeBrightness', $event)"
        :display-buttons="false"
      />
    </div>
    ...
    <div class="setting">
      ...
      <RangeSlider
        :max="100"
        v-model="contrast"
        @update:model-value="emit('changeContrast', $event)"
        :display-buttons="false"
      />
    </div>
  </div>
